...
use app\components\liquid\Liquid\Exception\WrongArgumentException;
...
class Filterbank
{
	...
	public function __construct(Context $context)
	{
		...
		$this->addFilter(\app\components\liquid\Liquid\StandardFilters::class);
		$this->addFilter(\app\components\liquid\Liquid\CustomFilters::class);
	}
	 ...
	 *
	 * @throws \app\components\liquid\Liquid\Exception\WrongArgumentException
	 * @return bool
	 */
