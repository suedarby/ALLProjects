...
class AppController extends Controller
{
     ...
     * @throws NotFoundHttpException
     */
    public function actionForm($id, $sid = 0, $t = 1, $b = 1, $js = 1, $rec = 1, $p = 1)
    {
     ...
     * @throws NotFoundHttpException
     */
    public function actionForms($slug, $sid = null, $t = 1, $b = 1, $js = 1, $rec = 1, $p = 1)
    {
     ...
     */
    public function actionEmbed($id, $sid = 0, $t = 1, $js = 1, $rec = 1, $p = 1)
    {
