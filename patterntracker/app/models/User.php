...
class User extends BaseUser
{
    ...
    {
        return $this->hasMany(Form::class, ['created_by' => 'id'])->inverseOf('author');
    }
    ...
    {
        return $this->hasMany(Theme::class, ['created_by' => 'id'])->inverseOf('author');
    }
    ...
    {
        return $this->hasMany(Template::class, ['created_by' => 'id'])->inverseOf('author');
    }
    ...
    {
        return $this->hasMany(Addon::class, ['created_by' => 'id'])->inverseOf('owner');
    }
    ...
    {
        return $this->hasMany(FormUser::class, ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(ThemeUser::class, ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(AddonUser::class, ['user_id' => 'id']);
    }
