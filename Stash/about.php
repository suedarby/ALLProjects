                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul>
                                    ...
                                    <li> <a href="https://www.linkedin.com/company/sue's-tiny-costumes/"> <i
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul>
                                    <li> <a href="http://www.books-music-more.com/" target="_blank">
                                            <i class="fa fa-link" aria-hidden="true"></i> Books, Music &amp; More! </a>
                                    </li>
                                </ul>
                            </p>
                        </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul>
                                    <li><a href="http://www.craft-pattern-emporium.com" target="_blank"><i
                                                class="fa fa-link" aria-hidden="true"></i> Craft Pattern Emporium </a>

                                    </li>
                                    <li> <a href="https://www.facebook.com/craftpatternemporium">
                                            <i class="fa fa-facebook-official" aria-hidden="true"></i> Page
                                        </a></li>
                                </ul>
                            </p>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul>
                                    <li> <a href="http://www.coffee-institute.com/" target="_blank">
                                            <i class="fa fa-link" aria-hidden="true"></i> Coffee Institute </a></li>
                                    <li> <a href="https://www.facebook.com/CoffeeInstitute/">
                                            <i class="fa fa-facebook-official" aria-hidden="true"></i> Page</a></li>
                                </ul>
                            </p>
                        </div>
                    </div>
