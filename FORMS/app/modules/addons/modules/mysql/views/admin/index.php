...
/* @var $searchModel app\modules\addons\modules\mysql\models\MySQLSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'MySQL');
            ...
            <div class="col-md-12">
                <?= GridView::widget([
                    ...
                    'panel' => [
                        ...
                        'heading'=> Yii::t('app', 'MySQL')
                            . ' <small class="panel-subtitle hidden-xs">'
                            . Yii::t('app', 'Saving form data to a MySQL database')
                            . '</small>',
