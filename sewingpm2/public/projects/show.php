...
echo h($id);
 ...
 $page_title = 'Show Project Details'
?>
        ...
        <div class="flex-column">           
            <div class="row">
                <div class="  justify-content-between flex-wrap  align-items-top pt-3 pb-2 mb-3 border-bottom"> 
                    <a class="back-link" href="<?php echo url_for('./projects/index.php'); ?>">&laquo; Back to List</a>  
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text">This pulls from the descriptions for Pattern, Fabric, Notions, Trims. It pulls the status of the project along with any other needed information.This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                        <p class="card-text">
                            <ul class="list-left">
                                <li>Loops through list of data points for </li>
                                <li>status</li>
                                <li>project location?</li>
                                <li>supplies on hand</li>
