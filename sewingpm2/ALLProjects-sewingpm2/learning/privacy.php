        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <section class="container card card-body">
                    <h2>Who we are</h2>
                    Our website address is: http://sue-a-darby.com/learning.
                    <h1>THIS SITE IS HAND CODED AND THERE IS NO DATA COLLECTED! THIS IS A SAMPLE POLICY BASED ON ONE OF
                        MY WORDPRESS WEBSITES.</h1>
                    <h2>What personal data we collect and why we collect it</h2>
                    <h3>Comments</h3>
                    There is no mechanism for leaving comments on this portion of the site so we don't collect anything.
                    ...
                    This really really doesn't apply since we don't have a comments area at this time.
                    ...
                    <h3>Media</h3>
                    YOU as a visitor can't upload ANYTHING so DO NOT EVEN TRY! If you choose to download one of MY
                    images at least link back to my sites!
                    ...
                    on the website.
                    <h3>Contact forms</h3>
                    Contact is done via LinkedIn, FaceBook or even Twitter but NOT on this site. Each of those sites has
                    their own policies that I do NOT control.
                    <h3>Cookies</h3>
                    There are no comments allowed here so there are no cookies. Check your browser there is nothing
                    saved for this site.
                    ...
                    If you have an account and you log in to this site, we will set a temporary cookie to determine if
                    your browser accepts cookies. This cookie contains no personal data and is discarded when you close
                    your browser.
                    ...
                    <h3>Analytics</h3>
                    Eventually I will add this sub-site to my Google Analytics just to see how many people actually
                    visit it but other than that I don't care to keep your data or look deeper as this is a sample site
                    only.
                    <h2>Who we share your data with</h2>
                    Not likely to share data with anyone unless you count the cat!
                    <h2>How long we retain your data</h2>
                    You can't leave a comment so I don't have your data to give back to you.
                    ...
                    There are no accounts so I have no data to give you. Nor are there comments so I can't help you
                    there either.
                    ...
                    I don't have comments so there is no SPAM! YAY ME! Visitor comments may be checked through an
                    automated spam detection service.
                    <h2>Your contact information</h2>
                    Again contacting me is via LinkedIn, Twitter or FaceBook NOT here.
                    ...
                    There are no third parties for this site.
                    <h3>What automated decision making and/or profiling we do with user data</h3>
                    NO DATA NO PROFLINIG!
